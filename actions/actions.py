...
class ActionCaptureNombreCompleto(Action):
    ...
    def run(
        ...
        full_name_entity = next(
            tracker.get_latest_entity_values("nombre_completo"), None
        )
...
class ValidateInfoForm(FormValidationAction):
    ...
    # async def extract_nombre_completo(
    #     self, dispatcher: CollectingDispatcher, tracker: Tracker, domain: Dict
    # ) -> Dict[Text, Any]:
    #     text_of_last_user_message = tracker.latest_message.get("text")
    #     return {"nombre_completo": text_of_last_user_message}
